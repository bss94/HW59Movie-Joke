...
const MovieItem: React.FC<Props> = React.memo(({movie,removeItem,editItem}) => {
  ...
  return (
    <form className="row">
      <div className="col-10">
        <input type="text" className="form-control" id={`name${movieItem.id}`} value={movieItem.name} onChange={onMovieChange} />
      </div>
      <div className="col-2">
